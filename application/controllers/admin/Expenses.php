...
public function search_expenses(){
    ...
    $this->data["expense_types"] = $this->expense_model->getList("EXPENSE_TYPES", "expense_type_id", "expense_type", $where ="");
        ...
        $this->data["title"] = $this->lang->line('Add New Expense');$this->data["view"] = ADMIN_DIR."expenses/add_expense";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
    ...
    $this->data["expense_types"] = $this->expense_model->getList("EXPENSE_TYPES", "expense_type_id", "expense_type", $where ="");
        ...
        $this->data["title"] = $this->lang->line('Edit Expense');$this->data["view"] = ADMIN_DIR."expenses/edit_expense";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
