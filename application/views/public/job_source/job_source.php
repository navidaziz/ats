...
<th><?php echo $this->lang->line('job_source_logo'); ?></th><th><?php echo $this->lang->line('Action'); ?></th>
                        </tr>
						</thead>
						<tbody>
            ...
            ?>
                                ...
                                <a class="llink llink-view" href="<?php echo site_url("job_source/view_job_source/".$job_source->job_source_id."/".$this->uri->segment(4)); ?>"> View </a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
