    ...
    foreach($menu_arr as $controller_id => $controller_data){
        ...
        if(isset($controller_data['actions']) and is_array($controller_data['actions'])){
            ...
            foreach($controller_data['actions'] as $action){
                ...
                $menu_list .= "<li class='".$class."'><a class='' href='".site_url(ADMIN_DIR.$controller_data['controller_uri']."/".$action['action_uri'])."'><span class='sub-menu-text'>".$action['action_title']."</span></a></li>";
