	...
	<div class="box border blue" id="messenger">
        ...
        <div class="box-body">
            ...
            <?php
                ...
                echo form_open_multipart(ADMIN_DIR."jobs/save_data", $add_form_attr);
            ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <?php
                    echo form_dropdown("job_source_id", $job_source, "", "class=\"form-control\" required style=\"\"");
                    ?>
                </div>
            ...
            <div class="form-group">
                ...
                <?php
                    $label = array(
                        "class" => "col-md-2 control-label",
                        "style" => "",
                    ); echo form_label($this->lang->line('job_image'), "job_image", $label);      ?>
