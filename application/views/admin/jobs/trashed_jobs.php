...
<th><?php echo $this->lang->line('job_image'); ?></th>
<th><?php echo $this->lang->line('job_source_title'); ?></th>
            ...
            <td>
                <?php echo $job->job_source_title; ?>
                            ...
                            <td>
                                <a class="llink llink-view" href="<?php echo site_url(ADMIN_DIR."jobs/view_job/".$job->job_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-eye"></i> </a>
                                <a class="llink llink-restore" href="<?php echo site_url(ADMIN_DIR."jobs/restore/".$job->job_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-undo"></i></a>
                                <a class="llink llink-delete" href="<?php echo site_url(ADMIN_DIR."jobs/delete/".$job->job_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-times"></i></a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
