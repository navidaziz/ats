...
<th><?php echo $this->lang->line('courier_type'); ?></th>
            ...
            <td>
                <?php echo $income->customer_name; ?>
            </td>
            <td>
                <?php echo $income->customer_mobile_number; ?>
            </td>
            <td>
                <?php echo $income->customer_address; ?>
            </td>
            <td>
                <?php echo $income->project_name; ?>
            </td>
            <td>
                <?php echo $income->project_address; ?>
            </td>
            <td>
                <?php echo $income->total_price; ?>
            </td>
            <td>
                <?php echo $income->discount; ?>
            </td>
            <td>
                <?php echo $income->courier_type; ?>
            </td>
                            
                            <td>
                                <a class="llink llink-view" href="<?php echo site_url(ADMIN_DIR."income/view_income/".$income->income_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-eye"></i> </a>
                                <a class="llink llink-restore" href="<?php echo site_url(ADMIN_DIR."income/restore/".$income->income_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-undo"></i></a>
                                <a class="llink llink-delete" href="<?php echo site_url(ADMIN_DIR."income/delete/".$income->income_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-times"></i></a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
