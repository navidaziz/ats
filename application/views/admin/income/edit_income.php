	...
	<div class="box border blue" id="messenger">
        ...
        <div class="box-body">
            ...
            <?php
                ...
                echo form_open_multipart(ADMIN_DIR."income/update_data/$income->income_id", $edit_form_attr);
            ?>
            <?php echo form_hidden("income_id", $income->income_id); ?>
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("customer_name", $income->customer_name),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("customer_mobile_number", $income->customer_mobile_number),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("customer_address", $income->customer_address),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("project_name", $income->project_name),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("project_address", $income->project_address),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $number = array(
                        ...
                        "value"         =>  set_value("total_price", $income->total_price),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $number = array(
                        ...
                        "value"         =>  set_value("discount", $income->discount),
					...
					$options = array("Yes" => "Yes", "No" => "No");
                        foreach($options as $option_value => $options_name){
                            ...
                            $data = array(
                                ...
                                "class"       => "uniform"
                                );if($option_value == $income->courier_type){
                                    $data["checked"] = TRUE;
                                }
