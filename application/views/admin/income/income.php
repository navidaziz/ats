      ...
      $(document).keypress(function(e) {
        ...
        <div class="box-body">
          ...
          <table class="table" style="text-align:center !important">
              <tr >
                  <td> <input style="cursor: pointer;" type="radio" id="sms" name="reference" value="sms"><label for="sms">SMS</label> </td><td>
                  <input style="cursor: pointer;" type="radio" id="whatsapp" name="reference" value="whatsapp"><label for="whatsapp">Whatapp</label> </td>
                  <td>
                  <input style="cursor: pointer;" type="radio" id="facebook" name="reference" value="facebook"><label for="whatapp">Facebook</label> </td>
                  <td>
                  <input style="cursor: pointer;" type="radio" id="advertisment" name="reference" value="advertisment"><label for="advertisment">Advertisment</label></td><td>
                  <input style="cursor: pointer;" type="radio" id="fm" name="reference" value="fm"><label for="fm">FM Radio</label></td>
          ...
          <table>
              ...
              <tr>
                  ...
                  <th><h3>Total</h3></th>
                  <th colspan="2"><h3>Rs: <strong id="g_total">0</strong></h3></th>
                  <th colspan="2">
            ...
            <table class="table table-bordered" >
              <thead>
                <tr>
                  ...
                  <th>Online</th><th>Print</th><th>Courier</th><th>Spe. Charges</th><th>Others</th>
