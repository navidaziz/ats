    ...
    <div class="col-md-4">
      <div class="box border blue" id="messenger">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
              <?php
                    ...
                    ?>
                    <button type="button" class="btn btn-link btn-small" data-toggle="modal" data-target="#myModal">Add New Expense Type</button>
            </div>
            <?php echo form_error("expense_type_id", "<p class=\"text-danger\">", "</p>"); ?> </div>
          <div class="form-group">
            <?php
                    $label = array(
                        "class" => "col-md-2 control-label",
          ...
          <div class="col-md-12"> <span class="pull-left"> <a class="btn btn-danger" href="<?php echo base_url(ADMIN_DIR."income/view"); ?>" >Add Income</a> </span> <span class="pull-right">
            <?php
                $submit = array(
                    "type"  =>  "submit",
                    "name"  =>  "submit",
